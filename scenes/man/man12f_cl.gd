...
func _on_Hotspot3_pressed():
	...
	$bur_k.show()
	(MdnaCore.state as GameState).bor_opened = 0
...
func _on_Hotspot6_pressed():
	...
	Boombox.play_effect(preload("res://sounds/man/wood_click.ogg"))
	$bur_b.show()
	(MdnaCore.state as GameState).bor_opened = 1
	yield(get_tree().create_timer(0.4), "timeout")
	$bur_b.hide()
	get_tree().paused = false
	Boombox.ignore_pause = false
...
func _on_Hotspot2_pressed():
	if (MdnaCore.state as GameState).bor_opened == 1:
		Boombox.ignore_pause = true
		get_tree().paused = true
		Boombox.play_effect(preload("res://sounds/man/wood_click.ogg"))
		$bur_j.show()
		(MdnaCore.state as GameState).bor_opened = 2
		yield(get_tree().create_timer(0.4), "timeout")
		$bur_j.hide()
		get_tree().paused = false
		Boombox.ignore_pause = false
...
func _on_Hotspot7_pressed():
	if (MdnaCore.state as GameState).bor_opened == 2:
		Boombox.ignore_pause = true
		get_tree().paused = true
		Boombox.play_effect(preload("res://sounds/man/wood_click.ogg"))
		$bur_6.show()
		(MdnaCore.state as GameState).bor_opened = 3
		yield(get_tree().create_timer(0.4), "timeout")
		$bur_6.hide()
		get_tree().paused = false
		Boombox.ignore_pause = false
...
func _on_Hotspot8_pressed():
	if (MdnaCore.state as GameState).bor_opened == 3 && (MdnaCore.state as GameState).man_folder_seen == 1:
		Boombox.ignore_pause = true
		get_tree().paused = true
		Boombox.play_effect(preload("res://sounds/man/wood_click.ogg"))
		$bur_1.show()
		...
		yield(get_tree().create_timer(0.4), "timeout")
		$bur_1.hide()
		(MdnaCore.state as GameState).man_hand_on_bur = true
